...
<div>
  ...
  <?php if ($setting_permissions['cookie_domain'] === true) : ?>
  ...
  <div class="tw-border tw-border-solid tw-border-gray-400 tw-bg-white tw-mb-5">
      ...
      <div class="tw-p-3">
        ...
        <?php if(is_multisite()): ?>
          <p class="tw-text-red-600 tw-mt-0">For WordPress Multisite, only a Super Admin has access to this setting. By setting the cookie domain, you may be sharing your user's visited pages information on this site to another site on the Multisite.</p>

          <p class="tw-text-red-600">You can setup once for all sites in the <a href="<?php echo esc_url(AFL_WC_UTM_ADMIN::get_url('network-settings')); ?>">Network Settings</a> page.</p>
          <hr>
        <?php endif; ?>

        <div>Get your visitors to use the same conversion attribution journey for all your WordPress websites under the same domain name. You must also setup this plugin on your other subdomains.</div>
