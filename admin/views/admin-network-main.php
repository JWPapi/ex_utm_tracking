        ...
        <div class="tw-col-span-1 xl:tw-col-span-6 tw-p-5">
          ...
          <div class="tw-text-justify">
            ...
            <ol>
              ...
              <li>Adjust <a href="<?php echo AFL_WC_UTM_ADMIN::get_url('network-settings'); ?>">Network Settings</a> for a more accurate attribution report.</li>
              ...
              <li>Remember to clear your page cache when you update our plugin.</li>
              <li>Join our <a href="https://www.facebook.com/groups/appfromlab/" target="_blank" rel="noreferrer noopener">Facebook Group</a> to report bugs, share tips and request features.</li>
            </ol>
