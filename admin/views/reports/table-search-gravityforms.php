    ...
    <div class="tw-grid lg:tw-grid-cols-4 tw-gap-4 tw-bg-white tw-border-solid tw-border tw-border-gray-400 tw-p-5 tw-mt-4">
      ...
      <div class="">
        ...
        <div class="tw-flex tw-flex-col tw-mt-4">
          <div class=""><label class="tw-font-bold tw-text-gray-600" for="input-s_id"><?php esc_html_e('Entry ID', AFL_WC_UTM_TEXTDOMAIN); ?></label></div>
          <div class="tw-mt-2"><input type="text" class="tw-w-full" id="input-s_id" name="s_id" value="<?php echo esc_attr($form_values['s_id']); ?>"></div>
        </div>
      ...
      <div class="">
        <div class="tw-text-lg tw-font-bold"><?php esc_html_e('Date Submitted', AFL_WC_UTM_TEXTDOMAIN); ?></div>

        <div class="tw-flex tw-flex-col tw-mt-4">
          <div class=""><label class="tw-font-bold tw-text-gray-600" for="input-s_date_created_from">From Date</label></div>
          <div class="tw-mt-2"><input type="date" class="tw-w-full" id="input-s_date_created_from"  name="s_date_created[from]" value="<?php echo esc_attr($form_values['s_date_created']['from']); ?>"></div>
        </div>

        <div class="tw-flex tw-flex-col tw-mt-4">
          <div class=""><label class="tw-font-bold tw-text-gray-600" for="input-s_date_created_to">To Date</label></div>
          <div class="tw-mt-2"><input type="date" class="tw-w-full" id="input-s_date_created_to"  name="s_date_created[to]" value="<?php echo esc_attr($form_values['s_date_created']['to']); ?>"></div>
        </div>
